...
var yaml = require('../yaml-indent-documents');
var render = require('./render');

var Index = exports.Index = function(indexfile) {
  this.indexfile = path.resolve(indexfile);
  this.basepath = path.dirname(this.indexfile);
};

Index.prototype.toString = function() {
  return '<<Index:' + (this.meta && this.meta.title || this.indexfile) + '>>';
};
...
Object.defineProperties(Index.prototype, {
  ...
  documents: {
    ...
    get: function() {
      if (!this._documents) {
        this._documents = yaml.parseDocsFile(this.indexfile);
      }
